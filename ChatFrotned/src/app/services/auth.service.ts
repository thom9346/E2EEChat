...
export class AuthService {
  ...
  register(username: string, email: string, password: string, publicKey: string): Observable<any> {
    return this.http.post<any>(`${this.apiUrl}/Auth/Register`, { username, email, password, publicKey });
  }
